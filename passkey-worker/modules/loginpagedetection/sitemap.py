...
class Sitemap:
    ...
    def __init__(self, config: dict, result: dict):
        ...
        self.max_candidates = config.get("login_page_config", {}).get("sitemap_strategy_config", {}).get("max_candidates", 1)
        self.max_recursion_level = config.get("login_page_config", {}).get("sitemap_strategy_config", {}).get("max_recursion_level", 0)
        self.max_sitemap_size = config.get("login_page_config", {}).get("sitemap_strategy_config", {}).get("max_sitemap_size", 50000000)
        self.timeout_fetch_sitemap = config.get("login_page_config", {}).get("sitemap_strategy_config", {}).get("timeout_fetch_sitemap", 10)
        self.store_sitemap = config.get("artifacts_config", {}).get("store_sitemap", False)
