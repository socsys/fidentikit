...
class Robots:
    ...
    def __init__(self, config: dict, result: dict):
        ...
        self.max_candidates = config.get("login_page_config", {}).get("robots_strategy_config", {}).get("max_candidates", 1)
        self.timeout_fetch_robots = config.get("login_page_config", {}).get("robots_strategy_config", {}).get("timeout_fetch_robots", 10)
        self.store_robots = config.get("artifacts_config", {}).get("store_robots", False)
