...
class Paths:
    ...
    def __init__(self, config: dict, result: dict):
        ...
        self.paths = config.get("login_page_config", {}).get("paths_strategy_config", {}).get("paths", ["/login", "/signin"])
        self.subdomains = config.get("login_page_config", {}).get("paths_strategy_config", {}).get("subdomains", ["login", "signin"])
