...
class Crawling:
    ...
    def __init__(self, config: dict, result: dict):
        ...
        crawling_strategy_config = login_page_config.get("crawling_strategy_config", {})
        self.login_page_url_regexes = login_page_config.get("login_page_url_regexes", [])
        self.login_page_element_keywords = login_page_config.get("login_page_element_keywords", [])
        self.max_anchor_candidates = crawling_strategy_config.get("max_anchor_candidates", 10)
        self.max_element_candidates = crawling_strategy_config.get("max_element_candidates", 10)
        self.max_elements_to_click = crawling_strategy_config.get("max_elements_to_click", 5)
