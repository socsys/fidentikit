...
class Paths:
    ...
    def __init__(self, config: dict, result: dict):
        ...
        paths_strategy_config = login_page_config.get("paths_strategy_config", {})
        self.paths = paths_strategy_config.get("paths", ["/login", "/signin", "/account/login", "/auth"])
        self.subdomains = paths_strategy_config.get("subdomains", ["login", "signin", "account"])
