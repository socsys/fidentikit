...
class Searxng:
    ...
    def __init__(self, config: dict, result: dict):
        ...
        metasearch_strategy_config = login_page_config.get("metasearch_strategy_config", {})
        self.search_engines = metasearch_strategy_config.get("search_engines", ["google", "bing"])
        self.search_term = metasearch_strategy_config.get("search_term", "%s login")
        self.search_results_number = metasearch_strategy_config.get("search_results_number", 10)
